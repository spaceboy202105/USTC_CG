...
int main()
{
	...
	// ------------------------------------
	gl::Shader vs(gl::ShaderType::VertexShader, "../data/shaders/dn_displacement.vert");
	gl::Shader fs(gl::ShaderType::FragmentShader, "../data/shaders/light_dn_displacement.frag");
